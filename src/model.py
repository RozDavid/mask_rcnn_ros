"""
Mask R-CNN
The main Mask R-CNN models implemenetation.
...
def build_rpn_model(anchor_stride, anchors_per_location, depth):
    """Builds a Keras models of the Region Proposal Network.
    ...
    Returns a Keras Model object. The models outputs, when called, are:
    rpn_logits: [batch, H, W, 2] Anchor classifier logits (before softmax)
...
class MaskRCNN():
    ...
    The actual Keras models is in the keras_model property.
    """
    ...
    def build(self, mode, config):
        """Build Mask R-CNN architecture.
            ...
            mode: Either "training" or "inference". The inputs and
                outputs of the models differ accordingly.
        """
        assert mode in ['training', 'inference']
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        # In multi-GPU training, we wrap the models. Get layers
        # of the inner models because they have the weights.
    ...
    def compile(self, learning_rate, momentum):
        """Gets the models ready for training. Adds losses, regularization, and
    ...
    def set_trainable(self, layer_regex, keras_model=None, indent=0, verbose=1):
        ...
        for layer in layers:
            # Is the layer a models?
            if layer.__class__.__name__ == 'Model':
                print("In models: ", layer.name)
                self.set_trainable(
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers):
        ...
        """
        assert self.mode == "training", "Create models in training mode."
    ...
    def detect(self, images, verbose=0):
        ...
        """
        assert self.mode == "inference", "Create models in inference mode."
        assert len(
